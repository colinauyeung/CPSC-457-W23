...
int main(){
    ...
    //This example will show how to grab that information from ls!
    ...
    if(id == 0){ //This is the child
        ...
        //With our child process, we're going to be running "ls"
        ...
        char program[] = "ls";
        char options[] = "-al";
        //And now let's just setup and replace the process code with ls
        char * args[] = {program, options, NULL};
        execvp(program, args);
